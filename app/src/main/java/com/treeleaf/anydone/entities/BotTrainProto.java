...
public final class BotTrainProto {
  ...
  public interface BotTrainingCompleteEventOrBuilder extends
    ...
    /**
     * <code>optional bool error = 11;</code>
     */
    boolean getError();

    /**
     * <code>optional string msg = 12;</code>
     */
    ...
    /**
     * <code>optional .treeleaf.protos.ErrorCode errorCode = 13;</code>
     */
    ...
    /**
     * <code>optional string botVersionId = 17;</code>
     */
  ...
  checkByteStringIsUtf8(value);
    ...
    public static final int BOTVERSIONID_FIELD_NUMBER = 17;
  ...
  checkByteStringIsUtf8(value);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (error_ != false) {
        output.writeBool(11, error_);
      }
      if (!msg_.isEmpty()) {
        output.writeString(12, getMsg());
      }
      ...
      if (!botVersionId_.isEmpty()) {
        output.writeString(17, getBotVersionId());
      }
    }
    ...
    public int getSerializedSize() {
      ...
      if (error_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(11, error_);
      }
      if (!msg_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeStringSize(12, getMsg());
      }
      if (errorCode_ != com.treeleaf.anydone.entities.TreeleafProto.ErrorCode.UNKNOWN_ERROR.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (!botVersionId_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeStringSize(17, getBotVersionId());
      }
      memoizedSerializedSize = size;
      return size;
    }
