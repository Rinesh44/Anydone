...
public class Inbox {
    ...
    String subject;
    String inboxType;
    List<com.treeleaf.anydone.serviceprovider.model.Participant> participantList;
    ...
    public List<com.treeleaf.anydone.serviceprovider.model.Participant> getParticipantList() {
        return participantList;
    }

    public void setParticipantList(List<com.treeleaf.anydone.serviceprovider.model.Participant> participantList) {
