...
public final class TicketParserHousekeepingRpcProto {
  ...
  checkByteStringIsUtf8(value);
    ...
    private void addAllTicketCreateRules(
        Iterable<? extends com.treeleaf.anydone.entities.TicketParserHousekeepingProto.TicketCreateRule> values) {
      ensureTicketCreateRulesIsMutable();
      com.google.protobuf.AbstractMessageLite.addAll(
    ...
    public static TicketParserHousekeepingBaseRequest parseFrom(
    ...
    public static TicketParserHousekeepingBaseRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static TicketParserHousekeepingBaseRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
    ...
    public static TicketParserHousekeepingBaseRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static TicketParserHousekeepingBaseRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(TicketParserHousekeepingBaseRequest prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          TicketParserHousekeepingBaseRequest, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new TicketParserHousekeepingBaseRequest();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          TicketParserHousekeepingBaseRequest other = (TicketParserHousekeepingBaseRequest) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (TicketParserHousekeepingBaseRequest.class) {
              if (PARSER == null) {
    ...
    private static final TicketParserHousekeepingBaseRequest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TicketParserHousekeepingBaseRequest();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static TicketParserHousekeepingBaseRequest getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  checkByteStringIsUtf8(value);
    ...
    public static TicketParserHousekeepingBaseResponse parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    ...
    public static TicketParserHousekeepingBaseResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static TicketParserHousekeepingBaseResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, input);
    }
    ...
    public static TicketParserHousekeepingBaseResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static TicketParserHousekeepingBaseResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    ...
    public static Builder newBuilder(TicketParserHousekeepingBaseResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          TicketParserHousekeepingBaseResponse, Builder> implements
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new TicketParserHousekeepingBaseResponse();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          TicketParserHousekeepingBaseResponse other = (TicketParserHousekeepingBaseResponse) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (TicketParserHousekeepingBaseResponse.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
    ...
    private static final TicketParserHousekeepingBaseResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TicketParserHousekeepingBaseResponse();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static TicketParserHousekeepingBaseResponse getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
