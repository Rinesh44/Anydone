...
import com.anydone.desk.injection.component.DaggerApplicationComponent;
...
import com.anydone.desk.realm.AnydoneRealmMigration;
import com.anydone.desk.utils.Constants;
import com.anydone.desk.utils.GlobalUtils;
import com.anydone.desk.utils.LocaleHelper;
...
public class AnyDoneServiceProviderApplication extends Application {
    ...
    private void initializeRealm() {
        ...
        RealmConfiguration config = new RealmConfiguration.Builder()
                ...
                .schemaVersion(29) // Must be bumped when the schema changes
