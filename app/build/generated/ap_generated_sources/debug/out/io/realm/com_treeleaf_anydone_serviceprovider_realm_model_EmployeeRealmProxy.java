...
public class com_treeleaf_anydone_serviceprovider_realm_model_EmployeeRealmProxy extends com.treeleaf.anydone.serviceprovider.realm.model.Employee
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Employee", 7, 0);
    ...
    public static long insert(Realm realm, com.treeleaf.anydone.serviceprovider.realm.model.Employee object, Map<RealmModel,Long> cache) {
        ...
        String realmGet$email = ((com_treeleaf_anydone_serviceprovider_realm_model_EmployeeRealmProxyInterface) object).realmGet$email();
        if (realmGet$email != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.emailIndex, rowIndex, realmGet$email, false);
        }
        String realmGet$phone = ((com_treeleaf_anydone_serviceprovider_realm_model_EmployeeRealmProxyInterface) object).realmGet$phone();
        if (realmGet$phone != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.phoneIndex, rowIndex, realmGet$phone, false);
        }
        String realmGet$name = ((com_treeleaf_anydone_serviceprovider_realm_model_EmployeeRealmProxyInterface) object).realmGet$name();
