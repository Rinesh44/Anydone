...
public class com_treeleaf_anydone_serviceprovider_realm_model_TicketsRealmProxy extends com.treeleaf.anydone.serviceprovider.realm.model.Tickets
    ...
    static final class TicketsColumnInfo extends ColumnInfo {
        ...
        TicketsColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.createdByPicIndex = addColumnDetails("createdByPic", "createdByPic", objectSchemaInfo);
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.createdByNameIndex = src.createdByNameIndex;
            dst.createdByPicIndex = src.createdByPicIndex;
    ...
    public String realmGet$createdByName() {
        proxyState.getRealm$realm().checkIfValid();
        return (java.lang.String) proxyState.getRow$realm().getString(columnInfo.createdByNameIndex);
    }
    ...
    public void realmSet$createdByName(String value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            if (value == null) {
                row.getTable().setNull(columnInfo.createdByNameIndex, row.getIndex(), true);
                return;
            }
            row.getTable().setString(columnInfo.createdByNameIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        if (value == null) {
            proxyState.getRow$realm().setNull(columnInfo.createdByNameIndex);
            return;
        }
        proxyState.getRow$realm().setString(columnInfo.createdByNameIndex, value);
    }
    ...
    public String realmGet$createdByPic() {
        proxyState.getRealm$realm().checkIfValid();
        return (java.lang.String) proxyState.getRow$realm().getString(columnInfo.createdByPicIndex);
    }
    ...
    public void realmSet$createdByPic(String value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            if (value == null) {
                row.getTable().setNull(columnInfo.createdByPicIndex, row.getIndex(), true);
                return;
            }
            row.getTable().setString(columnInfo.createdByPicIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        if (value == null) {
            proxyState.getRow$realm().setNull(columnInfo.createdByPicIndex);
            return;
        }
        proxyState.getRow$realm().setString(columnInfo.createdByPicIndex, value);
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Tickets", 15, 0);
        ...
        builder.addPersistedProperty("createdByName", RealmFieldType.STRING, !Property.PRIMARY_KEY, !Property.INDEXED, !Property.REQUIRED);
        builder.addPersistedProperty("createdByPic", RealmFieldType.STRING, !Property.PRIMARY_KEY, !Property.INDEXED, !Property.REQUIRED);
    ...
    public static com.treeleaf.anydone.serviceprovider.realm.model.Tickets createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (json.has("createdByName")) {
            if (json.isNull("createdByName")) {
                objProxy.realmSet$createdByName(null);
            } else {
                objProxy.realmSet$createdByName((String) json.getString("createdByName"));
            }
        }
        if (json.has("createdByPic")) {
            if (json.isNull("createdByPic")) {
                objProxy.realmSet$createdByPic(null);
            } else {
                objProxy.realmSet$createdByPic((String) json.getString("createdByPic"));
            }
        }
        if (json.has("assignedEmployee")) {
    ...
    public static com.treeleaf.anydone.serviceprovider.realm.model.Tickets createUsingJsonStream(Realm realm, JsonReader reader)
        ...
        while (reader.hasNext()) {
            ...
            } else if (name.equals("createdByName")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$createdByName((String) reader.nextString());
                } else {
                    reader.skipValue();
                    objProxy.realmSet$createdByName(null);
                }
            } else if (name.equals("createdByPic")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$createdByPic((String) reader.nextString());
                } else {
                    reader.skipValue();
                    objProxy.realmSet$createdByPic(null);
                }
    ...
    public static com.treeleaf.anydone.serviceprovider.realm.model.Tickets copy(Realm realm, TicketsColumnInfo columnInfo, com.treeleaf.anydone.serviceprovider.realm.model.Tickets newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        builder.addString(columnInfo.createdByNameIndex, realmObjectSource.realmGet$createdByName());
        builder.addString(columnInfo.createdByPicIndex, realmObjectSource.realmGet$createdByPic());
    ...
    public static long insert(Realm realm, com.treeleaf.anydone.serviceprovider.realm.model.Tickets object, Map<RealmModel,Long> cache) {
        ...
        String realmGet$createdByName = ((com_treeleaf_anydone_serviceprovider_realm_model_TicketsRealmProxyInterface) object).realmGet$createdByName();
        if (realmGet$createdByName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdByNameIndex, rowIndex, realmGet$createdByName, false);
        }
        String realmGet$createdByPic = ((com_treeleaf_anydone_serviceprovider_realm_model_TicketsRealmProxyInterface) object).realmGet$createdByPic();
        if (realmGet$createdByPic != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdByPicIndex, rowIndex, realmGet$createdByPic, false);
        }
    ...
    public static long insertOrUpdate(Realm realm, com.treeleaf.anydone.serviceprovider.realm.model.Tickets object, Map<RealmModel,Long> cache) {
        ...
        if (realmGet$createdByName != null) {
            ...
            Table.nativeSetNull(tableNativePtr, columnInfo.createdByNameIndex, rowIndex, false);
        }
        String realmGet$createdByPic = ((com_treeleaf_anydone_serviceprovider_realm_model_TicketsRealmProxyInterface) object).realmGet$createdByPic();
        if (realmGet$createdByPic != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdByPicIndex, rowIndex, realmGet$createdByPic, false);
        } else {
            Table.nativeSetNull(tableNativePtr, columnInfo.createdByPicIndex, rowIndex, false);
        }
    ...
    public static com.treeleaf.anydone.serviceprovider.realm.model.Tickets createDetachedCopy(com.treeleaf.anydone.serviceprovider.realm.model.Tickets realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        unmanagedCopy.realmSet$createdByName(realmSource.realmGet$createdByName());
        unmanagedCopy.realmSet$createdByPic(realmSource.realmGet$createdByPic());
    ...
    public String toString() {
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{createdByName:");
        stringBuilder.append(realmGet$createdByName() != null ? realmGet$createdByName() : "null");
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{createdByPic:");
        stringBuilder.append(realmGet$createdByPic() != null ? realmGet$createdByPic() : "null");
        stringBuilder.append("}");
        stringBuilder.append(",");
