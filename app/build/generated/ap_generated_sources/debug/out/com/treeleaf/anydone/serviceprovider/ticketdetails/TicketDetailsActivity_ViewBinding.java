...
public class TicketDetailsActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public TicketDetailsActivity_ViewBinding(TicketDetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TicketDetailsActivity_ViewBinding(TicketDetailsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TicketDetailsActivity target = this.target;
